...
var _selected_backend: String = "MockIndustrial"
...
func _setup_ui() -> void:
	...
	# Title
	_title = Label.new()
	_title.text = "Select Industrial Robot"
	...
	# Add backend options
	_add_backend_option("MockIndustrial", "Mock Robot",
...
func _add_backend_option(backend_id: String, title: String, description: String, available: bool) -> void:
	...
	radio.button_group = "industrial_backend"
	radio.text = ""
	...
	if available and _selected_backend == "MockIndustrial":
...
static func get_backend_class(backend_id: String) -> IndustrialBackend:
	match backend_id:
		"MockIndustrial":
